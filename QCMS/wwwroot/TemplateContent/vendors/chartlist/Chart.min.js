...
!(function (t, e) {
    ...
    st._set("global", { elements: { line: { tension: 0.4, backgroundColor: St, borderWidth: 3, borderColor: St, borderCapStyle: "butt", borderDash: [], borderDashOffset: 0, borderJoinStyle: "miter", capBezierPoints: !0, fill: !0 } } });
    var Pt = pt.extend({
        draw: function () {
            var t,
                e,
            ...
            for (
                ...
                (e = s[t]),
                    ...
                    (n = e._view),
                    0 === t ? n.skip || (o.moveTo(n.x, n.y), (u = t)) : ((i = -1 === u ? i : s[u]), n.skip || ((u !== t - 1 && !r) || -1 === u ? o.moveTo(n.x, n.y) : ut.canvas.lineTo(o, i._view, e._view), (u = t)));
            o.stroke(), o.restore();
        },
    }),
    ...
    function Rt(t) {
        var e, i, n, a, o;
        return (
            Lt(t) ? ((o = t.width / 2), (e = t.x - o), (i = t.x + o), (n = Math.min(t.y, t.base)), (a = Math.max(t.y, t.base))) : ((o = t.height / 2), (e = Math.min(t.x, t.base)), (i = Math.max(t.x, t.base)), (n = t.y - o), (a = t.y + o)),
    ...
    st._set("bar", { hover: { mode: "label" }, scales: { xAxes: [{ type: "category", categoryPercentage: 0.8, barPercentage: 0.9, offset: !0, gridLines: { offsetGridLines: !0 } }], yAxes: [{ type: "linear" }] } });
    var Yt = Mt.extend({
        ...
        updateElement: function (t, e, i) {
            ...
            (t._xScale = n.getScaleForId(a.xAxisID)),
                ...
                (t._index = e),
                (t._model = { backgroundColor: r.backgroundColor, borderColor: r.borderColor, borderSkipped: r.borderSkipped, borderWidth: r.borderWidth, datasetLabel: o.label, label: n.chart.data.labels[e] }),
        ...
        calculateBarValuePixels: function (t, e) {
            ...
            return (
                (o = u.getPixelForValue(v)), (s = (r = u.getPixelForValue(v + f)) - o), void 0 !== g && Math.abs(s) < g && ((s = g), (r = (f >= 0 && !h) || (f < 0 && h) ? o - g : o + g)), { size: s, base: o, head: r, center: r + s / 2 }
            );
        },
    ...
    st._set("horizontalBar", {
        ...
        scales: { xAxes: [{ type: "linear", position: "bottom" }], yAxes: [{ type: "category", position: "left", categoryPercentage: 0.8, barPercentage: 0.9, offset: !0, gridLines: { offsetGridLines: !0 } }] },
    ...
    var ne = Mt.extend({
        ...
        update: function (t) {
            ...
            for (
                d && (void 0 !== l.tension && void 0 === l.lineTension && (l.lineTension = l.tension), (o._scale = s), (o._datasetIndex = n.index), (o._children = r), (o._model = n._resolveLineOptions(o)), o.pivot()),
                e = 0,
                i = r.length;
                e < i;
                ++e
        ...
        draw: function () {
            ...
            for (
                ...
                ((t = (i.dataset._model.borderWidth || 0) / 2), ut.canvas.clipArea(e.ctx, { left: a.left, right: a.right, top: a.top - t, bottom: a.bottom + t }), i.dataset.draw(), ut.canvas.unclipArea(e.ctx));
                r < o;
                ++r
            )
                n[r].draw(a);
    ...
    var de = Mt.extend({
        ...
        update: function (t) {
            var e,
                ...
                l = n.getDataset();
            for (
                void 0 !== l.tension && void 0 === l.lineTension && (l.lineTension = l.tension), o._scale = s, o._datasetIndex = n.index, o._children = r, o._loop = !0, o._model = n._resolveLineOptions(o), o.pivot(), e = 0, i = r.length;
                e < i;
                ++e
            )
                n.updateElement(r[e], e, t);
    ...
    ut.extend(ni.prototype, {
        ...
        initialize: function () {
            var t = this;
            return (
                Ee.notify(t, "beforeInit"), ut.retinaScale(t, t.options.devicePixelRatio), t.bindEvents(), t.options.responsive && t.resize(!0), t.ensureScalesHaveIDs(), t.buildOrUpdateScales(), t.initToolTip(), Ee.notify(t, "afterInit"), t
            );
        },
        clear: function () {
    ...
    st._set("scale", {
        ...
        ticks: { beginAtZero: !1, minRotation: 0, maxRotation: 50, mirror: !1, padding: 0, reverse: !1, display: !0, autoSkip: !0, autoSkipPadding: 0, labelOffset: 0, callback: li.formatters.values, minor: {}, major: {} },
    });
    var fi = pt.extend({
        getPadding: function () {
    ...
    var Ci = fi.extend({
        ...
        handleTickRangeOptions: function () {
            ...
            (t.min = _i(e.min, t.min)),
                ...
                t.min === t.max && (0 !== t.min && null !== t.min ? ((t.min = Math.pow(10, Math.floor(ut.log10(t.min)) - 1)), (t.max = Math.pow(10, Math.floor(ut.log10(t.max)) + 1))) : ((t.min = 1), (t.max = 10))),
        ...
        draw: function () {
            ...
            if (i.display) {
                ...
                (e.fillStyle = ut.valueOrDefault(i.fontColor, st.global.defaultFontColor)),
                    (e.font = r.string),
                    t.isHorizontal() ? ((a = h + (f - h) / 2), (o = u + l), (n = f - h)) : ((a = "left" === i.position ? h + l : f - l), (o = u + (c - u) / 2), (n = c - u), (d = Math.PI * ("left" === i.position ? -0.5 : 0.5))),
                    e.save(),
                    e.translate(a, o),
                    e.rotate(d),
                    (e.textAlign = "center"),
